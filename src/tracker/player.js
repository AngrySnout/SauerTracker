...
const emptyStats = {
	frags: 0, flags: 0, deaths: 0, tks: 0, accFrags: 0,
};
...
export function sumModeStats(newModeStats, oldModeStatsString) {
	...
	const newModeStatsArray = [newModeStats.frags, newModeStats.flags, newModeStats.deaths,
		newModeStats.tks, newModeStats.accFrags];
